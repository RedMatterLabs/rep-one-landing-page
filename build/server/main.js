...
/******/ 			var chunk = require("./" + ({"0":"home"}[chunkId]||chunkId) + "-" + {"0":"d51be5edab74f4bed87a"}[chunkId] + ".js");
...
const importHome = (nextState, cb) => {
  __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 62)).then(module => cb(null, module.default)).catch(e => {
    throw e;
  });
};
