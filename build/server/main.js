...
/******/ 			var chunk = require("./" + ({"0":"home"}[chunkId]||chunkId) + "-" + {"0":"37ce02dee239f55c967b"}[chunkId] + ".js");
...
const importHome = (nextState, cb) => {
  __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 69)).then(module => cb(null, module.default)).catch(e => {
    throw e;
  });
};
