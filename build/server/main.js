...
/******/ 			var chunk = require("./" + ({"0":"home"}[chunkId]||chunkId) + "-" + {"0":"48517abfe99bd2a81544"}[chunkId] + ".js");
...
const importHome = (nextState, cb) => {
  __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 60)).then(module => cb(null, module.default)).catch(e => {
    throw e;
  });
};
