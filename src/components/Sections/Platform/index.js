	    	...
	    	<div className={styles.main}>
        		...
        		<h2>RepOne streamlines autoregulation and individualized coaching.</h2>
       			...
       			<div className={styles.appscontainer}>
       				...
       				<div className={styles.ipadcontainer}>
       					<img src={require('src/images/R1 Coach - Programs.png')} alt='RepOne coaching Programs'/>
       				</div>
       				<div className={styles.ipadcontainer}>
       					<img src={require('src/images/R1 Coach - Dashboard.png')} alt='RepOne coaching Dashboard'/>
       				</div>
       			</div>
        	</div>
        </div>  
